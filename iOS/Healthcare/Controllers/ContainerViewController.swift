...
class ContainerViewController: UIViewController, CenterViewControllerDelegate, UIGestureRecognizerDelegate {
    ...
    */
    func populateSidePanelWithUserData() {
        ...
        let localizedDate = NSDateFormatter.localizedStringFromDate(thePatient.dateOfNextVisit, dateStyle: NSDateFormatterStyle.ShortStyle, timeStyle: NSDateFormatterStyle.NoStyle)
