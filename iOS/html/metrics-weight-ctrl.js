...
/**
 *  @class ReadyAppHC.milCtrl.milTabbedGraphCtrl.milSyncedGraphCtrl.metricsWeightCtrl
 *  @augments ReadyAppHC.milCtrl.milTabbedGraphCtrl.milSyncedGraphCtrl
 *  @memberOf ReadyAppHC
 *  @description Controller the operates the steps metric view after tapping the "weight" graph
 *  in the {@linkcode metricsCtrl}.
 *  @see {@linkcode metrics-weight.html}
 *
 ...
 *  @property {string} currPerformance  - The value for the weight in {@linkcode currTimeFrame}.
 *
 *  @author Jonathan Ballands
 *  @copyright © 2014 IBM Corporation. All Rights Reserved.
 */

angular.module('ReadyAppHC').controller('metricsWeightCtrl', function($scope, $controller, $filter, tab) {
     ...
     *  @param {string} performance The weight in the time frame (eg: 3,904).
     */
