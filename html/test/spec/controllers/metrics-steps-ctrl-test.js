...
describe("metricsStepsCtrl", function() {
    ...
    var metricsStepsCtrl;
    
    // Create metricsCtrl
    beforeEach(inject(function(_$filter_) {
        metricsHrCtrl = $controller('metricsStepsCtrl', {
            $scope: $scope,
            $controller: $controller,
            $filter: _$filter_,
            tab: 48
    ...
    it("should have correct initial property values", function() {
        ...
        expect($scope.currGoal).toBe("...");
        expect($scope.baseRoute).toBe("/WebView/metrics_steps");
    });
    ...
    it("should set properties based on setters", function() {
        ...
        $scope.setGoal(9001);
        expect($scope.currGoal).toBe(9001);
        $scope.setGoal("Over nine-thousand");
        expect($scope.currGoal).toBe("Over nine-thousand");
    });
